...
## Feb 2020 (version 0.17.0)

***Breaking change: All previous job will disappear after upgrading to v0.17.0***

Welcome to the Feb 2020 release of OpenPAI. There are a number of updates in this version that we hope you will like, some of the key highlights include:

- Deployment - Improve deployment process
    - Improve deployment process, reduce the time cost [#4022](https://github.com/microsoft/pai/issues/4022)
    - Add deployment pre-check [#1893](https://github.com/microsoft/pai/issues/1893)
    - Remove yarn version components in k8s version object model [#4027](https://github.com/microsoft/pai/issues/4027)
- Protocol
    - Remove job name length limit [#3935](https://github.com/microsoft/pai/issues/3935) [#4069](https://github.com/microsoft/pai/issues/4069)
- Security
    - Enable https for K8S Dashboard [#4025](https://github.com/microsoft/pai/issues/4025)
    - Add REST API for checking node/pod status [#3892](https://github.com/microsoft/pai/issues/3892)
    - Pass secret field in job config to runtime [#3572](https://github.com/microsoft/pai/issues/3752)
- UI
    - New header, left navigation and command bar [#3985](https://github.com/microsoft/pai/issues/3985) [#4057](https://github.com/microsoft/pai/issues/4057)
    - New homepage [#3712](https://github.com/microsoft/pai/issues/3712) [#4074](https://github.com/microsoft/pai/issues/4074)
    - WebUI Font Format Adjustment [#3877](https://github.com/microsoft/pai/issues/3877)
    - Replace code injection in webportal with new plugin implementation [#3823](https://github.com/microsoft/pai/issues/3823)

- Bug fix:
    - Remove framework owner reference for priority class & default not to create priority class [#4131](https://github.com/microsoft/pai/pull/4131)
    - Job retry link invalid with unknown reason [#4008](https://github.com/microsoft/pai/pull/4008)
    - Do not change the semantic meaning of user submitted/cloned job config [#3823](https://github.com/microsoft/pai/pull/3823)
    - Storage manager constantly restart [#4081](https://github.com/microsoft/pai/pull/4081)
- Others
    - Remove invalid chart in Grafana Dashboard [#4020](https://github.com/microsoft/pai/pull/4020)
    - Watchdog auto delete leaked priorityclass [#3866](https://github.com/microsoft/pai/pull/3866)
    - Check ACS Docker Image in initContainer [#3572](https://github.com/microsoft/pai/pull/3572)
    - For basic authentication mode, prepare document to explain how to create a group and associate users to the group [#4130](https://github.com/microsoft/pai/pull/4130)
    - Support to add Pod Creation http error pattern to errorspec [#4125](https://github.com/microsoft/pai/pull/4125)
