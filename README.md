...
OpenPAI is an open source platform that provides complete AI model training and resource management capabilities. Built on top of Kubernetes and Docker, OpenPAI naturely supports on-premise, cloud and hybrid environments in various scale; With a well designed componentized architecture, OpenPAI is easy to be extended; 
