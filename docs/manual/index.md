...
- Design documents could be found [here](https://github.com/microsoft/pai/tree/master/docs) if you are curious.
...
We are glad to have [Peking University](https://eecs.pku.edu.cn/Home/HOME.htm), [Xi'an Jiaotong University](http://www.aiar.xjtu.edu.cn/), [Zhejiang University](http://www.cesc.zju.edu.cn/index_e.htm), [University of Science and Technology of China](http://eeis.ustc.edu.cn/) and [SHANGHAI INESA AI INNOVATION CENTER (SHAIIC)](https://www.shaiic.com/en/) joined us to develop the platform jointly.
